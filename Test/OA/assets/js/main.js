$(document).ready(function() {
	...
	$("#userDrop .sub-menu a").hover(
		function(){
			$(this).css({backgroundColor: "#3498db", color: "#fff", textShadow:" 0 -1px 0 rgba(0,0,0,.5)"});
		},
		function(){
			$(this).css({backgroundColor: "#f5f5f5", color: "#222", textShadow: "0 1px rgba(255,255,255,0.8)"});
		}
	);
	...
	$(".user-btn").hover(
		function(){
			$(this).css({backgroundColor: "#fafafa", background: "linear-gradient(#e7e7e7,#fefefe)"});
		},
		function(){
			$(this).css({backgroundColor: "#ecf0f1", background: "linear-gradient(#fefefe,#e7e7e7)"});
		}
	);
	...
	$(".tree-child-btn").hover(
		function(){
			$(this).css({backgroundColor: "#ffefdf", color: "#3498db"});
		},
		function(){
